...
<html>
    ...
    <body>
        ...
        <!--<div style= "backgroundimage: url(../../images/NAF1.jpg)" width="1200px" height="200px"></div>-->
        <nav class="navbar navbar-default navbar-static-top" style="margin-top: -3.5em;">
            <div class="container-fluid top-gp"> 
                ...
                <div class="navbar-header">
                    ...
                    <!--<a class="navbar-brand navbar-left" href="#" id='logo'><img src="../../images/naflogo.jpg">NAF RECRUITMENT SYSTEM</a>--> 
