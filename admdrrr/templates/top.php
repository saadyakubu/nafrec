...
<!--                    <a class="navbar-brand" href="#" id='logo'>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
                    ...
                    <ul class="nav navbar-nav">
                        <li style="padding-left: 420px;">
                            <a href="#" id="menu-text" style="color: azure"><span class="fa fa-dashboard"></span> Admin Dashboard</a>
                        </li>
                    </ul>
                        ...
                        <nav class="navbar navbar-default" role="navigation" >
                            ...
                            <div class="side-menu-container">
                                <ul class="nav navbar-nav side-menu-gp">
                                    <li class="active1"><a href="../overview.php" class="fa fa-home" id="menu-text"> Home <span class="badge badge-info"><?php echo $number['number']; ?></span></a></li>
                                    <li class="panel panel-default" id="dropdown">
                                        ...
                                        <div id="dropdown-candidate" class="panel-collapse collapse">
                                            ...
                                            <ul class="nav navbar-nav">
                                                <li><a href="../dssc/index.php" id='menu-text'> <span>DSSC</span></a></li>
                                                <li><a href="../recruit/index.php" id='menu-text'> Recruit</a></li>
                                            </ul>
                                    ...
                                    <li  class="panel panel-default" id="dropdown">
                                        <a data-toggle="collapse" href="#dropdown-specialty" href="#" class="fa fa-university" id='menu-text'>
                                            Centre
                                            <span class="caret"></span>
                                        </a>
                                        ...
                                        <div id="dropdown-specialty" class="panel-collapse collapse">
                                            ...
                                            <ul class="nav navbar-nav">
                                                <li><a href="../dssc/centres_candidates.php" id='menu-text'> DSSC</a></li>
                                    ...
                                    <li><a href="../logout.php" class="fa fa-sign-out" style="margin-top: 30%" id='menu-text'> Logout</a></li>
