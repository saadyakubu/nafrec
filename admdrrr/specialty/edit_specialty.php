<link rel="stylesheet" href="../css/admin.css">
	...
	if(isset($specialty_id_v))//($pst_id != null)
	{
            ...
            //get pet by ID
            $result = get_specialty($specialty_id_v);
        ...
        <div class="starter-template">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form  method="post" action="edit_specialty_process.php" class="form-horizontal" id="specialtyform_validation">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-3">
                                <button type="submit" class="btn btn-success fa fa-edit" name="edit" value="Edit">Edit Specialty</button>
                            </div>
                        </div>
