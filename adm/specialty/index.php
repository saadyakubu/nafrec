                    ...
                    <table id="editTable" class="table table-striped table-condensed">					
                        ...
                        foreach ($results as $result):
                            ...
                            <tr>
                                ...
                                <td   style="width: 5em;">
                                    <form onsubmit="return confirm('Do you really want to delete this specialty?');"
                                          action ="delete_specialty.php" method="post">
                                ...
                                <td>
                                    <form action ="edit_specialty.php" method="post" id ="edit_specialty.php">
                                        <input type="hidden" name="specialty_id" value="<?php echo htmlspecialchars($result['specialty_id']); ?> " />
