        ...
        <div class="starter-template">
            <div class="row">
				...
				<?php //include_once("../global/header.php")?><h2>Centres</h2>
                    ...
                    <form  method="post" action="add_centre_process.php" class="form-horizontal" id="centreform_validation">

                        <div class="form-group">
                            <label class="col-sm-4 control-label">Centre Name:</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" maxlength="100" name="centre_name" placeholder="(max 50 characters)" value ="<?php echo htmlspecialchars($centre_name);?>" />
                            </div>
                        </div>
